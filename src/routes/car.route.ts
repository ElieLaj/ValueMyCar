...
router.get("/:id", Auth.checkJWT, (req, res, next) => carController.getCar(req as EncodedRequest, res, next))
router.get("/", Auth.checkJWT, (req, res, next) => carController.getCars(req as EncodedRequest, res, next))
